...
## Managing length and order of strings
Now that we now how to retrieve headlines, let us have a look at the headlines we got for 1 Septemeber. First, we might be interested to order them alphabetically. We can use str_sort for this.
...
## Ideas for assignments during the live coding session:

1.) Scrape the newspaper articles on the date of your most recent birthday. What were the most common nouns?

2.) What was the average length of headlines that day? 

3.) Assign https://www.foxnews.com/, https://www.bbc.com/, https://www.bbc.com/, https://www.dailymail.co.uk/home/index.html
